...
_C.SOLVER.ACC = False
_C.SOLVER.PS_THRESH = 0.6
_C.SOLVER.SAMPLE_NEG = True

_C.INPUT.USE_SUP_TRAIN_AUG_WEAK = True
_C.INPUT.USE_SUP_TRAIN_AUG_STRONG = True
_C.INPUT.USE_UNSUP_TRAIN_AUG_STRONG = True


_C.DATASETS.FRAC = 0.999
_C.DATASETS.UNSUP_FRAC = 1.0
_C.DATASETS.USE_SUP_AS_UNSUP = False
_C.DATASETS.UNSUP_EXCLUDE_SUP = True
_C.DATASETS.TRAIN_UNSUP = ("coco_2017_train",)
